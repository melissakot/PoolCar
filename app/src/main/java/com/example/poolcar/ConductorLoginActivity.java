    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!=null){
                    Intent intent = new Intent(ConductorLoginActivity.this, ConductorMapAcrivity.class);
        ...
        mRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(ConductorLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(ConductorLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            Toast.makeText(ConductorLoginActivity.this, "error en log in", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
